...
def main():
    ...
    fig.suptitle("Contour plots during 14 Oct 2023 Eclipse", fontsize=18, y=0.86, fontweight="bold")
    ...
    fig.savefig("manuscript_figures/FigureS03.png", dpi=300, bbox_inches="tight")
    plt.close(fig)
