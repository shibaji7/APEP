...
def main():
    ...
    fig.suptitle("(2) Plasma Frequency Response during 08 Apr 2024 Eclipse", fontsize=15, y=0.87, fontweight="bold")
    ...
    fig.savefig("manuscript_figures/Figure04.png", dpi=300, bbox_inches="tight")
    plt.close(fig)
